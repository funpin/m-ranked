...
Baseline аудита: историческое состояние ветки alpha на 2026-09-08,
divergence +0/-4 относительно тогдашней origin/alpha. Существующий dirty
worktree был сохранён. Production, существующая БД и пользовательские данные не
изменялись. SHA намеренно не указан: последующая санкционированная реконструкция
истории не должна превращать историческую привязку в висячую ссылку.
