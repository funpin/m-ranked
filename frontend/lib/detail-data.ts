...
export async function loadAccountPublications(id: number | string, type?: LegacyAccountType) {
...
export async function loadPublicationHistory(id: number | string, type?: LegacyPublicationType): Promise<DetailHistory> {
