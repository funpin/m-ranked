...
читают только снимки своей сети. Рейтинг и сравнение этих сетей пока показывают
переходное состояние. Будущий режим «Общий» станет сводкой по площадкам, а не
суммой несопоставимых реакций.
