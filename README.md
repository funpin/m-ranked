...
Выбранная площадка сохраняется в URL, фильтрах и основной навигации. Текущий
полноценный вертикальный сценарий — TG; для остальных площадок до подключения
расчётов показываются аккаунты, покрытие, состояние сбора и соответствующий
срез М‑Рейтинга без подстановки Telegram-цифр. Рейтинг, сравнение и экспорт в
таких режимах показывают переходное состояние или явный отказ. Будущий режим
«Общий» станет сводкой по площадкам, а не суммой несопоставимых реакций.
