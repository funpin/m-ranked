...
делённая на просмотры, а кривые строятся на постоянной когорте публикаций.
Рейтинг и сравнение MAX/Rutube пока показывают переходное состояние. Будущий
режим «Общий» станет сводкой по площадкам, а не суммой несопоставимых реакций.
