...
Целевой обзор имеет общий переключатель `Общий / TG / VK / MAX / RUTUBE`.
Выбранная площадка сохраняется во всём маршруте до страницы публикации,
сравнения и экспорта. Текущий интерфейс является готовым вариантом режима TG;
режим «Общий» будет сводкой по площадкам, а не суммой несопоставимых реакций.
