-- Дельта для боевой базы: та же витрина, что и в миграции 0022, но пригодная
-- к повторному применению. Только добавление объекта — существующие таблицы,
-- данные и права не затрагиваются, поэтому применяется без остановки сервисов.
...
CREATE TABLE IF NOT EXISTS analytics.overview_card_metrics (
